...
<body class="bg-gradient-primary">
              ...
              <div class="col-lg-8">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h1 text-gray-800 mb-4">Blood Bank &bullet; <span class="h3 text-gray-900 mb-4">Admin Login</span></h1>
  ...
  if (isset($_POST['login'])) {
    ...
    $loginQ = 'SELECT * FROM admin where usersname = "'.$username.'" AND password = "'.$password.'"';
    ...
    if ($loginR=$conn->query($loginQ)) {
      $loginR= $loginR->fetch_assoc();
        ...
        // session_start();
      if (is_array($loginR)) {
        $_SESSION['BB_ADMIN'] = $loginR;

        // var_dump($_SESSION['BB_ADMIN']);?>
<script>
